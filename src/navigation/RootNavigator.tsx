...
import { PrivacyScreen } from '../screens/overlays/PrivacyScreen';
import { ActivityScreen } from '../screens/overlays/ActivityScreen';
...
export function RootNavigator() {
  return (
    <Stack.Navigator screenOptions={{ headerShown: false, animation: 'slide_from_right' }}>
      ...
      <Stack.Screen name="Activity" component={ActivityScreen} options={{ animation: 'fade' }} />
